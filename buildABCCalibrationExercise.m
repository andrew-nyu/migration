...
mcParams = table([],[],[],[],'VariableNames',{'Name','Lower','Upper','RoundYN'});
    ...
    mcParams = [mcParams; {'modelParameters.coeffPoverty', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffFood', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffHealth', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffEducation', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffGender', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffWater', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffEnergy', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffEconomy', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffInnovation', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffInequality', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffCities', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffConsumption', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffClimate', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffOcean', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffLand', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffPeace', 0, 100, 0}];
    mcParams = [mcParams; {'modelParameters.coeffCooperation', 0, 100, 0}];
