function [locationLikelihood, genderLikelihood, ageLikelihood, survivalRate, fertilityRate, agePointsPopulation, agePointsSurvival, agePointsFertility] = buildDemography(modelParameters, locations)
