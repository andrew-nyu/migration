...
modelParameters.coeffPoverty=2;
modelParameters.coeffFood=2;
modelParameters.coeffHealth=2;
modelParameters.coeffEducation=2;
modelParameters.coeffGender=2;
modelParameters.coeffWater=2;
modelParameters.coeffEnergy=2;
modelParameters.coeffEconomy=2;
modelParameters.coeffInnovation=2;
modelParameters.coeffInequality=2;
modelParameters.coeffCities=2;
modelParameters.coeffConsumption=2;
modelParameters.coeffClimate=2;
modelParameters.coeffOcean=2;
modelParameters.coeffLand=2;
modelParameters.coeffPeace=2;
modelParameters.coeffCooperation=2;
%
