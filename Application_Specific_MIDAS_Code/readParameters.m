...
agentParameters.bestLocationMean = 10;
agentParameters.bestLocationSD = 0;
agentParameters.bestPortfolioMean = 10;
agentParameters.bestPortfolioSD = 0;
agentParameters.randomLocationMean = 10;
agentParameters.randomLocationSD = 0;
agentParameters.randomPortfolioMean = 10;
...
% diegob: including SDG weights as agent parameters
agentParameters.coeffPoverty=2;
agentParameters.coeffFood=2;
agentParameters.coeffHealth=2;
agentParameters.coeffEducation=2;
agentParameters.coeffGender=2;
agentParameters.coeffWater=2;
agentParameters.coeffEnergy=2;
agentParameters.coeffEconomy=2;
agentParameters.coeffInnovation=2;
agentParameters.coeffInequality=2;
agentParameters.coeffCities=2;
agentParameters.coeffConsumption=2;
agentParameters.coeffClimate=2;
agentParameters.coeffOcean=2;
agentParameters.coeffLand=2;
agentParameters.coeffPeace=2;
agentParameters.coeffCooperation=2;
%
