...
mapParameters.sizeX = 1000;
mapParameters.sizeY = 1000;
...
mapParameters.milesPerDeg = 100; %use for estimating actual distances in distance Matrix
mapParameters.density = 100; %pixels per degree Lat/Long, if using .shp input
