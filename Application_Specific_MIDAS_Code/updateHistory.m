function utilityHistory = updateHistory(utilityVariables, modelParameters, indexT, countAgentsPerLayer)
...
utilityHistory = utilityVariables.utilityHistory;



onesList = ones(size(utilityHistory,1),1);

for indexL = 1:size(utilityHistory,2)
    utilityHistory(:,indexL, indexT) = arrayfun(utilityVariables.utilityLayerFunctions{indexL}, ...
